<?php
$pagetitle = "Wallpaper Cropper - Our Privacy Policy";
...
<section id="fullscreen-b">
  <div class="full-site-container">
    ...
    <div class="wallpaper-thumb-container-index">
        ...
        <p>This privacy policy is for this website wallpapercropper.com and served by Wallpaper Cropper and governs the privacy of its users who choose to use it.</p>
        ...
        <p>This website and its owners take a proactive approach to user privacy and ensure the necessary steps are taken to protect the privacy of its users throughout their visiting experience. This website complies to all UK national laws and requirements for user privacy.
        ...
        <p>This website and its owners through their social media platform accounts may share web links to relevant web pages. By default some social media platforms shorten lengthy urls.</p>
