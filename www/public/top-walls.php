<?php
$pagetitle = "Our Most Popular Wallpapers";
if($typea == null){}else{$pagetitle = $pagetitle . " (Page " . $typea . ")";}
$pagedescription = "Browse our most popular wallpaper collection";
$pagenate = 1;
$fullscreena=1;
...
<?php include($php_base_directory . 'ads/topad.php'); ?>
    <div class="full-site-container">
      ...
      <div class="wallpaper-thumb-container-index">
        ...
        <div class="pagenavi1">
          <?php $prefix="top-walls"; include('includes/pagenate.php'); ?>
        </div>
          ...
          if ($nsfw == 1){
            $mysqlquery="SELECT wallpapers.* FROM wallpapers WHERE NOT EXISTS (SELECT * FROM category_links WHERE category_id='4' AND wallpaper_id = wallpapers.id) AND hq='1' AND moderated='1' $filter ORDER BY trend DESC, views DESC LIMIT 24 OFFSET $offset";
          } else {
            $mysqlquery="SELECT wallpapers.* FROM wallpapers WHERE NOT EXISTS (SELECT * FROM category_links WHERE category_id='4' AND wallpaper_id = wallpapers.id) AND hq='1' AND moderated='1' AND sfw='1' $filter ORDER BY trend DESC, views DESC LIMIT 24 OFFSET $offset";
          }
