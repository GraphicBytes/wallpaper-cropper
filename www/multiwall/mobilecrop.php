...
if ($logged_in_id == 0) {
  ...
  if ($logged_in_id == $owner) {
    ...
    if ($checkwidth > $targ_w and $checkheight >$targ_h){
        ...
        $db->sql( "UPDATE wall_generation SET mobile_share=? WHERE id=?", 'si' , $Ifileroot, $iid );
    ...
    if ($checkwidth > $targ_w and $checkheight >$targ_h){
        ...
        $db->sql( "UPDATE wall_generation SET mobilethumb=? WHERE id=?", 'si' , $Ifileroot, $iid );
    ...
    if ($checkwidth > $targ_w and $checkheight >$targ_h){
        ...
        $db->sql( "UPDATE wall_generation SET mobilesmall=? WHERE id=?", 'si' , $Ifileroot, $iid );
    ...
    if ($checkwidth > $targ_w and $checkheight >$targ_h){
        ...
        $db->sql( "UPDATE wall_generation SET mobilemedium=? WHERE id=?", 'si' , $Ifileroot, $iid );
    ...
    if ($checkwidth > $targ_w and $checkheight >$targ_h){
        ...
        $db->sql( "UPDATE wall_generation SET mobilestandard=? WHERE id=?", 'si' , $Ifileroot, $iid );
    ...
    if ($checkwidth > $targ_w and $checkheight >$targ_h){
        ...
        $db->sql( "UPDATE wall_generation SET mobilelarge=? WHERE id=?", 'si' , $Ifileroot, $iid );
    ...
    $current_time = time();
    $db->sql( "UPDATE wall_generation SET mobile_recrop='1' WHERE id=?", 'i' , $iid );


    $location = "Location: " . $base_url . "/review/" . $iid . "/";

    $done_mobile_recrop = 1;
