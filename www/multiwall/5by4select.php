...
if ($logged_in_id == 0) {
  ...
  $pagetitle = "Wallpaper Cropper - The 5 by 4 crop";
  $loadingcss = 1;
  $jcrop = 1;
  $multiheader = 1;
  $mainoptions=1;
  ...
  <script>
          ...
          $("#loading").fadeOut("fast",function(){$( "#submit" ).show();});
  				return false;
  			};
  </script>
  ...
  <section id="fullscreen-flex">
    <div class="main-options-container-b">
      ...
      <div class="sub-header-multiwall">
        ...
        <?php if($done_4by3_recrop == 0){ ?><div class="multi-stage-off border">5by4</div><?php }else{ ?><a class="multi-stage-current border" href="<?php echo $base_url; ?>/5by4select/<?php echo $id; ?>/">5by4</a><?php } ?>
      ...
      <div class="fullscreen-container-b">
                ...
                <form action="<?php echo $base_url; ?>/5by4crop/<?php echo $iid ?>/" method="post" onsubmit="return checkCoords();">
