...
if ($logged_in_id == 0) {
  ...
  if ($logged_in_id == $owner) {
    ...
    $pagetitle = "Wallpaper Cropper - The 4 by 3 crop";
    $loadingcss = 1;
    $jcrop = 1;
    $multiheader = 1;
    $mainoptions = 1;
    ...
    <section id="fullscreen-flex">
      <div class="main-options-container-b">
        ...
        <div class="sub-header-multiwall">
          ...
          <?php if ($done_16by10_recrop == 0) { ?><div class="multi-stage-off border">4by3</div><?php } else { ?><a class="multi-stage-current border" href="<?php echo $base_url; ?>/4by3select/<?php echo $id; ?>/">4by3</a><?php } ?>
        ...
        <div class="fullscreen-container-b">
          ...
          <form action="<?php echo $base_url; ?>/4by3crop/<?php echo $iid ?>/" method="post" onsubmit="return checkCoords();">
