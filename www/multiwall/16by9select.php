...
if ($logged_in_id == 0) {
  ...
  if ($logged_in_id == $owner) {
    ...
    $pagetitle = "Wallpaper Cropper - The 16 by 9 crop";
    $loadingcss = 1;
    $jcrop = 1;
    $multiheader = 1;
    $mainoptions = 1;
    ...
    <section id="fullscreen-flex">
      <div class="main-options-container-b">
        ...
        <div class="sub-header-multiwall">
          <a class="multi-stage-current border" href="<?php echo $base_url; ?>/16by9select/<?php echo $id; ?>/">16by9</a>
        ...
        <div class="fullscreen-container-b">
          ...
          <form action="<?php echo $base_url; ?>/16by9crop/<?php echo $iid ?>/" method="post" onsubmit="return checkCoords();">
